...
isa_ok($spread_revolutionary_date->twitter, 'App::SpreadRevolutionaryDate::Target::Twitter', 'Twitter class constructor');
isa_ok($spread_revolutionary_date->twitter->obj, 'Net::Twitter::Lite::WithAPIv1_1', 'Twitter object');
isa_ok($spread_revolutionary_date->mastodon, 'App::SpreadRevolutionaryDate::Target::Mastodon', 'Mastodon class constructor');
isa_ok($spread_revolutionary_date->mastodon->obj, 'Mastodon::Client', 'Mastodon object');
isa_ok($spread_revolutionary_date->freenode, 'App::SpreadRevolutionaryDate::Target::Freenode', 'Freenode class constructor');
isa_ok($spread_revolutionary_date->freenode->obj, 'App::SpreadRevolutionaryDate::Target::Freenode::Bot', 'Freenode object');
